...
The frozen and scored candidate ledger from Phases 3–6 and the Phase 2 query/source log.
...
Stop only when a full audit pass yields zero new in-scope candidates or a precise source/access limitation prevents completion. Never call this an exhaustive real-world census.
