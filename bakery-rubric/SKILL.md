...
# Scratch-Bakery Scorecard & Travel Prompt (v8.9)
...
2. **Candidate discovery**  
   Read `../reference/phase-2-candidate-discovery.md` and `discovery-reference.md`. Run broad, targeted, visible-head, multilingual, adjacent-category, and marker-item discovery.
...
6. **Bakery scoring and classification**  
   Read `phase-6-scoring.md`. Apply the unchanged rubric yourself.
7. **Coverage audit**  
   Read `../reference/phase-7-coverage-audit.md` and `discovery-reference.md`. Newly found bakeries loop through Phases 4–6; repeat until the audit converges.
8. **Rendering**  
